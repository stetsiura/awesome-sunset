...
function sunset_load_admin_scripts( $hook ){
	...
	$pages_array = array(
		'toplevel_page_awesome_sunset',
		'sunset_page_awesome_sunset_theme',
		'sunset_page_awesome_sunset_theme_contact',
		'sunset_page_awesome_sunset_css'
	);
	...
	if( 'toplevel_page_awesome_sunset' == $hook ){
	...
	if ( 'sunset_page_awesome_sunset_css' == $hook ){
